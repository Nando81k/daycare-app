    ...
    data: [
      {
        ...
        autopayUpdatedAt: date("2026-03-08T15:35:00.000Z"),
      },
      {
        familyId: brooksFamily.id,
        ...
        autopayEnabled: true,
        autopayUpdatedAt: date("2026-04-01T13:00:00.000Z"),
    ...
    data: [
      {
        ...
        preferredTourTime: "Morning tour",
    ...
    data: [
      ...
      },
      {
        ...
        sectionDescription:
          "Operational settings that shape enrollment and family communication.",
        label: "Tour windows",
        value: "Weekday mornings and midday quiet blocks",
        sortOrder: 2,
      },
      {
        sectionKey: "school-defaults",
      ...
      },
      {
        ...
        sectionDescription:
          "Parent-facing payment expectations that should remain easy to explain.",
        label: "Autopay availability",
        value: "Enabled when Stripe is configured and a default card is on file",
        sortOrder: 3,
      },
      {
