...
import { House, ShieldCheck, Sparkles, WalletCards, Users } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-bg">
      <div className="grid min-h-screen lg:grid-cols-2">
        <section className="relative isolate flex items-center border-b border-white/15 bg-primary-900 px-6 py-8 text-white sm:px-10 sm:py-10 lg:border-b-0 lg:border-r lg:px-14 lg:py-12">
          ...
          <div className="relative z-10 w-full max-w-2xl">
            <CinematicReveal>
              ...
              <p className="mt-6 text-xs font-semibold uppercase tracking-[0.12em] text-teal-100">Parent Portal</p>
              ...
              <p className="mt-4 max-w-[54ch] text-base text-[#e4f4ff]">
                Check admissions progress, child records, and billing updates from one secure place.
              </p>
            </CinematicReveal>
            ...
            <CinematicStagger className="mt-6 grid gap-3 sm:grid-cols-2">
              <article className="rounded-field border border-white/24 bg-white/10 px-3.5 py-3" data-stagger-item>
                ...
                <p className="mt-1 text-xs text-[#d9ecff]">Protected sessions for family records and billing details.</p>
              </article>
              <article className="rounded-field border border-white/24 bg-white/10 px-3.5 py-3" data-stagger-item>
                <p className="inline-flex items-center gap-2 text-sm font-semibold text-white">
                ...
                <p className="mt-1 text-xs text-[#d9ecff]">See due now, payment history, and next actions.</p>
              </article>
            </CinematicStagger>
        ...
        <section className="flex items-center justify-center bg-[#eef5ff] px-6 py-8 sm:px-10 sm:py-10 lg:px-14 lg:py-12">
          <div className="w-full max-w-[31rem]">
            <CinematicReveal>
              ...
              <h2 className="mt-2 text-3xl font-semibold text-ink-900 sm:text-[2.1rem]">Sign In</h2>
              <p className="mt-2 text-base text-ink-600">Secure access to your family account.</p>
            </CinematicReveal>
            ...
            <CinematicReveal delay={0.1}>
              ...
              <p className="mt-3 inline-flex items-center gap-1.5 text-xs text-ink-500">
                ...
                Secure sign-in for parents and administrators
              </p>
            </CinematicReveal>
          </div>
        </section>
