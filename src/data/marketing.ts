...
export const marketingMedia = {
  heroPrimary: {
    ...
    caption: "Warm introductions, steady guidance, and classrooms built around relationship.",
  },
  heroSecondary: {
    src: "/marketing/storytime-classroom.jpg",
    alt: "A teacher reads with children gathered together during story time.",
    objectPosition: "center 42%",
    caption: "Story, conversation, and small-group attention during the school day.",
  },
  heroTertiary: {
    src: "/marketing/playroom-learning.jpg",
    alt: "Young children explore toys and materials in a bright playroom.",
    objectPosition: "center 48%",
    caption: "Purposeful play in spaces that feel calm instead of overstimulating.",
  },
  heroQuaternary: {
    src: "/marketing/calm-circle-time.jpg",
    alt: "Children sit together for a calm classroom activity with a caregiver nearby.",
    objectPosition: "center 38%",
    caption: "A quieter classroom rhythm that gives children time to settle in.",
  },
  programsInfants: {
    src: "/marketing/hero-daycare-circle.jpg",
    alt: "A caregiver kneels at child height to greet children in the classroom.",
    objectPosition: "center 34%",
    caption: "Attachment, routine, and soft transitions for the youngest children.",
  },
  programsToddlers: {
    src: "/marketing/playroom-learning.jpg",
    alt: "Toddlers play with toys and soft materials during open exploration time.",
    objectPosition: "center 48%",
    caption: "Language, movement, and confident exploration inside a steady rhythm.",
  },
  programsPreschool: {
    src: "/marketing/storytime-classroom.jpg",
    alt: "Preschool children gather with a teacher during a classroom story session.",
    objectPosition: "center 40%",
    caption: "Projects, storytelling, and collaborative learning that still feels calm.",
  },
  aboutStory: {
    src: "/marketing/calm-circle-time.jpg",
    alt: "Children participate in a calm group activity while seated together in class.",
    objectPosition: "center 38%",
    caption: "Rooms should feel settled, relational, and easy for families to trust.",
  },
  tuitionStory: {
    src: "/marketing/storytime-classroom.jpg",
    alt: "A classroom circle-time moment with children and caregiver gathered together.",
    objectPosition: "center 40%",
    caption: "Transparent pricing works best when it is tied to a real care environment.",
  },
  formStory: {
    src: "/marketing/hero-daycare-circle.jpg",
    alt: "A caregiver greets children near the floor in a welcoming classroom.",
    objectPosition: "center 36%",
    caption: "The first next step should feel clear, calm, and well supported.",
  },
  contactStory: {
    src: "/marketing/playroom-learning.jpg",
    alt: "Children play in a warm, light-filled daycare environment.",
    objectPosition: "center 48%",
