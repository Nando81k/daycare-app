    ...
    items: [
      {
        ...
        icon: ClipboardList,
        summary: "Submitted applications and the waitlist queue",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: MailOpen,
        summary: "Inbox threads and announcement drafts in one workspace",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/admin/settings",
        icon: Settings,
        summary: "Center policies, integrations, and two-factor security",
      },
      {
        title: "Audit log",
        href: "/admin/audit",
