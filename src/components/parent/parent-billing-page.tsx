      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.15fr)_minmax(22rem,0.85fr)]">
        <Card className="gap-0 border-border/65">
          <CardHeader className="gap-3 p-5 md:p-6">
            ...
            <CardDescription className="text-sm leading-6 text-muted-foreground">
              Review the current balance first, then manage your saved card and billing history below.
            </CardDescription>
          </CardHeader>
              ...
              <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(16rem,19rem)]">
                <div className="space-y-4 rounded-[1rem] border border-primary/14 bg-primary/6 px-5 py-5">
                  ...
                  <p className="text-sm leading-6 text-muted-foreground">
                    Use the secure payment page to review this invoice and submit payment.
                  </p>
                  {upcomingInvoice ? (
                ...
                <div className="flex flex-col justify-between gap-4 rounded-[1rem] border border-border/65 bg-muted/16 px-4 py-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm leading-6 text-muted-foreground">
                      Continue to the payment page to confirm the amount and complete payment.
                    </p>
                  </div>
                  <Link
                    href={`/parent/billing/pay/${dueInvoice.id}`}
                    className={`${buttonVariants({ variant: "default" })} w-full justify-center`}
                  >
                    Pay {dueInvoice.label}
                  </Link>
                </div>
              </div>
            ) : (
